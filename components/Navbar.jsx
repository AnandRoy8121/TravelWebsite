    ...
    <div
      className={`${
        scrolled
          ...
          : "absolute top-0 flex justify-between w-full items-center z-40 bg-blue-700 shadow-lg rounded-lg"
      }`}
    >
      <Link href={"/"}>
...
<div className="flex justify-center items-center lg:hidden">
      ...
      <div className={nav ?'fixed top-0 left-0 z-40 text-gray-300 w-full h-screen bg-transparent/80 px-4 py-7 flex-col ease-out duration-700':'absolute z-10 top-0 left-[-100%] duration-1000 ease-in h-screen'}>
            <ul className='flex flex-col items-center justify-center w-full h-full'>
                <Link href={'#'}><li className='font-bold text-2xl p-4 duration-75 translate-x-2 hover:scale-125 cursor-pointer'>Tour Packages</li></Link>
                <Link href={'/about'}><li className='font-bold text-2xl p-4  duration-75 translate-x-2 hover:scale-125 cursor-pointer'>Hotels</li></Link>
                <Link href={'/contact'}><li className='font-bold text-2xl p-4  duration-75 translate-x-2 hover:scale-125 cursor-pointer'>Vehicles</li></Link>
